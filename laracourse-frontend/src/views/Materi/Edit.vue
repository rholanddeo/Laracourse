          ...
          <div class="border rounded-lg bg-white">
            ...
            <div class="p-4">
              <form @submit.prevent="createMateri">
                ...
                <div class="mb-4">
                  <label class="block mb-2 text-sm font-medium text-gray-900">Link (Optional)</label>
                  <input type="text" v-model="form.link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
